        ...
        {isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-white border border-slate-200 rounded-[2rem] p-6 shadow-2xl z-10 overflow-hidden"
            >
              {/* Accent highlight */}
              <div className="absolute top-0 left-0 w-full h-1 bg-accent"></div>

              <div className="flex items-center justify-between mb-6 pt-2">
                <h3 className="text-xl font-extrabold tracking-tight text-navy">New Company</h3>
                <button 
                  type="button"
                  onClick={() => setIsOpen(false)}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label className="text-sm font-bold text-navy ml-1">Tax ID / EIN</label>
                  <div className="relative">
